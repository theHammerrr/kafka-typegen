...
export const ACTIVE_STREAM_CLOSE_ERROR_MESSAGE =
  'Cannot leave group while consuming messages.';

export function reportPlatformaticConsumerError(
  error: unknown,
...
export function buildPlatformaticConsumerOptionsSignature<TKey>(
